...
[`scripts/package-mac-app.sh`](https://github.com/ziomancer/openclaw/blob/main/scripts/package-mac-app.sh) copies this template into the app bundle and patches dynamic fields
